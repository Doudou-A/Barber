...
$(function () {
    $('body').on('click', '.zoomPresentationSnd', function () {
        $(this).removeClass('col-12').removeClass('position-absolute').removeClass('zoomPresentationSnd').removeClass('h-75').addClass('col-lg-3').addClass('col-5').addClass('hoverWB').addClass('hiddenPresentation').addClass('zoomPresentation');
